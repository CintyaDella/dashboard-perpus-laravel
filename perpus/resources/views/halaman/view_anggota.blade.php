    ...
    <table class="table table-bordered table-striped">
        <thead>
            <tr>
                ...
                <td style="width: 5%;" align="center">ID Anggota</td>
                <td style="width: 5%;" align="center">NIM</td>
                <td style="width: 20%;" align="center">Nama Anggota</td>
                <td style="width: 20%;" align="center">Prodi</td>
                <td style="width: 15%;" align="center">Nomor HP</td>
                <td style="width: 30%;" align="center">Aksi</td>
            </tr>
        </thead>
