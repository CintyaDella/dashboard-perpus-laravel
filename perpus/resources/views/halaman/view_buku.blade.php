    ...
    <table class="table table-bordered table-striped text-center">
        <thead>
            <tr>
                ...
                <td style="width: 5%;" align="center">ID Buku</td>
                <td style="width: 10%;" align="center">Kode Buku</td>
                <td style="width: 25%;" align="center">Judul Buku</td>
                <td style="width: 20%;" align="center">Pengarang</td>
                <td style="width: 10%;" align="center">Kategori</td>
                <td style="width: 25%;" align="center">Aksi</td>
            </tr>
        </thead>
